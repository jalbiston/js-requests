...
function sayhbColor(event) {
  sayHelloButton.style.backgroundColor = "black";
  // or sayHelloButton.classList.add(#cssclassname)
  sayHelloButton.style.color = "white";
}

sayHelloButton.addEventListener("mouseover", sayhbColor);
// PROBLEM 3
/*
...
sayHelloButton.addEventListener("mouseout", unhover);
